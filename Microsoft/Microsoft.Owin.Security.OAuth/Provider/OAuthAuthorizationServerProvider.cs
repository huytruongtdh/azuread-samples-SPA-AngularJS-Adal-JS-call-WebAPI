...
// Type: Microsoft.Owin.Security.OAuth.OAuthAuthorizationServerProvider
...
namespace Microsoft.Owin.Security.OAuth
{
  ...
  {
    /// <summary>Creates new instance of default provider behavior</summary>
    public OAuthAuthorizationServerProvider()
    {
      this.OnMatchEndpoint = (Func<OAuthMatchEndpointContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnValidateClientRedirectUri = (Func<OAuthValidateClientRedirectUriContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnValidateClientAuthentication = (Func<OAuthValidateClientAuthenticationContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      ...
      this.OnGrantResourceOwnerCredentials = (Func<OAuthGrantResourceOwnerCredentialsContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnGrantRefreshToken = DefaultBehavior.GrantRefreshToken;
      this.OnGrantClientCredentials = (Func<OAuthGrantClientCredentialsContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnGrantCustomExtension = (Func<OAuthGrantCustomExtensionContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnAuthorizeEndpoint = (Func<OAuthAuthorizeEndpointContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnTokenEndpoint = (Func<OAuthTokenEndpointContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnAuthorizationEndpointResponse = (Func<OAuthAuthorizationEndpointResponseContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
      this.OnTokenEndpointResponse = (Func<OAuthTokenEndpointResponseContext, Task>) (context => (Task) Task.FromResult<object>((object) null));
    }
    ...
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task MatchEndpoint(OAuthMatchEndpointContext context) => this.OnMatchEndpoint(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task ValidateClientRedirectUri(OAuthValidateClientRedirectUriContext context) => this.OnValidateClientRedirectUri(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task ValidateAuthorizeRequest(OAuthValidateAuthorizeRequestContext context) => this.OnValidateAuthorizeRequest(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task ValidateTokenRequest(OAuthValidateTokenRequestContext context) => this.OnValidateTokenRequest(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task GrantAuthorizationCode(OAuthGrantAuthorizationCodeContext context) => this.OnGrantAuthorizationCode(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task GrantRefreshToken(OAuthGrantRefreshTokenContext context) => this.OnGrantRefreshToken(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task GrantClientCredentials(OAuthGrantClientCredentialsContext context) => this.OnGrantClientCredentials(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task GrantCustomExtension(OAuthGrantCustomExtensionContext context) => this.OnGrantCustomExtension(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task AuthorizeEndpoint(OAuthAuthorizeEndpointContext context) => this.OnAuthorizeEndpoint(context);
    ...
    /// <param name="context">The context of the event carries information in and results out.</param>
    /// <returns>Task to enable asynchronous execution</returns>
    public virtual Task TokenEndpoint(OAuthTokenEndpointContext context) => this.OnTokenEndpoint(context);
    ...
    /// <returns></returns>
    public virtual Task TokenEndpointResponse(OAuthTokenEndpointResponseContext context) => this.OnTokenEndpointResponse(context);
  }
}
